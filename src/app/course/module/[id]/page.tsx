            ...
            <div className="bg-green-50 rounded-xl p-6">
              ...
              <ul className="space-y-3">
                <li className="flex items-start">
                  ...
                  <span className="text-green-700">Find a natural setting (park, garden, beach, or even a tree-lined street)</span>
                </li>
                <li className="flex items-start">
                  <span className="w-2 h-2 bg-green-600 rounded-full mr-3 mt-2"></span>
                  <span className="text-green-700">Set aside 20 uninterrupted minutes</span>
                </li>
                <li className="flex items-start">
                  <span className="w-2 h-2 bg-green-600 rounded-full mr-3 mt-2"></span>
                  <span className="text-green-700">After reading the instructions and downloading the audio we recommend switching your phone to airplane mode</span>
                </li>
                <li className="flex items-start">
                  <span className="w-2 h-2 bg-green-600 rounded-full mr-3 mt-2"></span>
                  <span className="text-green-700">Bring headphones</span>
                </li>
                <li className="flex items-start">
                  <span className="w-2 h-2 bg-green-600 rounded-full mr-3 mt-2"></span>
                  <span className="text-green-700">Approach with curiosity, not expectations</span>
                </li>
              </ul>
            </div>
          </div>
